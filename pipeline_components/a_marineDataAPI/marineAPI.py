...
class MarineDataPortalApi(object):
    ...
    def __init__(self):
        ...
        # datasets APIs/URLs
        """change csv 0 to regular csv with headers but no unites"""
        ...
        self.url_csv_IWaveBNetwork_spectral = "https://erddap.marine.ie/erddap/tabledap/IWaveBNetwork_spectral.csv?buoy_id%2Ctime%2Clatitude%2Clongitude%2Cstation_id%2CPeakDirection%2CPeakSpread%2CSignificantWaveHeight%2CEnergyPeriod%2CMeanWavePeriod_Tm01%2CMeanWavePeriod_Tm02%2CPeakPeriod%2Cqcflag&time%3E="
        self.url_csv_IWaveBNetwork_zerocrossing = "https://erddap.marine.ie/erddap/tabledap/IWaveBNetwork_zerocrossing.csv?buoy_id%2Ctime%2Clatitude%2Clongitude%2Cstation_id%2CHmax%2CHmaxPeriod%2CHavg%2CTavg%2Cqcflag&time%3E="
        self.url_csv_IrishNationalTideGaugeNetwork = "https://erddap.marine.ie/erddap/tabledap/IrishNationalTideGaugeNetwork.csv?longitude%2Clatitude%2Caltitude%2Ctime%2Cdatasourceid%2Cstation_id%2CWater_Level%2CWater_Level_LAT%2CWater_Level_OD_Malin%2CQC_Flag&time%3E="
        # https: // erddap.marine.ie / erddap / tabledap / IrishNationalTideGaugeNetwork.csv?longitude % 2
        # Clatitude % 2
        # Caltitude % 2
        # Ctime % 2
        # Cstation_id % 2
    ...
    def start_harvesting(self):
        #@TODO store times in json file // for crach handling
        returnMessage_file_locations = []
        ...
        for ds in ds_names_list:
            ...
            temp_obj = self.putCSVToFile(csvData, csvfileName)
            temp_obj['ds'] = ds
            returnMessage_file_locations.append(copy.deepcopy(temp_obj))


        return returnMessage_file_locations
    ...
    def putCSVToFile(self, csv_data, file_name):
        # print "waiting logic"
        return self.file_sys.store_csv_data_to_file_system(csv_data, file_name)
